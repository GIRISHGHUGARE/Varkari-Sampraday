...
// FILES
const { registerUser, verifyEmail, logout, loginUser, resendVerificationEmail, verifyUser, searchUser, updateUser, forgotPassword, resetPassword } = require('../controllers/userController');
